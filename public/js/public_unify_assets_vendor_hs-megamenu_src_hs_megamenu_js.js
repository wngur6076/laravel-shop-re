(self["webpackChunk"] = self["webpackChunk"] || []).push([["public_unify_assets_vendor_hs-megamenu_src_hs_megamenu_js"],{

/***/ "./public/unify/assets/vendor/hs-megamenu/src/hs.megamenu.js":
/*!*******************************************************************!*\
  !*** ./public/unify/assets/vendor/hs-megamenu/src/hs.megamenu.js ***!
  \*******************************************************************/
/***/ (() => {
  ...
  MegaMenu.prototype.bindEvents = function () {
    ...
    if (this.options.event === 'hover' && !_isTouch()) {
      this.$element.on('mouseenter.HSMegaMenu', this.options.classMap.hasMegaMenu + ':not([data-event="click"]),' + this.options.classMap.hasSubMenu + ':not([data-event="click"])', function (e) {
        ...
        e.preventDefault();
        e.stopPropagation();
      }).on('click.HSMegaMenu', this.options.classMap.hasMegaMenu + '[data-event="click"] > a, ' + this.options.classMap.hasSubMenu + '[data-event="click"] > a', function (e) {
